...
public class ClimbingroseInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_climbingrose_info);
        ...
        // Bind UI components
        statusTextView = findViewById(R.id.textView8); // Status TextView
        saveButton = findViewById(R.id.btn_saveR); // Save Button

        mAuth = FirebaseAuth.getInstance();
        db = FirebaseFirestore.getInstance();
        commentButton = findViewById(R.id.btn_roseComment);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivity(new Intent(ClimbingroseInfo.this, ClimbingRoseComment.class));
                } catch (Exception e) {
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Climbingrose"));
    }
