...
public class GumamelaComment extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        CollectionReference commentsRef = db.collection("plants").document("Gumamela").collection("comments");
    ...
    private void submitComment() {
        ...
        db.collection("users").document(userId).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    db.collection("plants").document("Gumamela").collection("comments")
                            .add(newComment)
