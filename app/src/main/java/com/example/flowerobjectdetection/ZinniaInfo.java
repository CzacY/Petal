...
public class ZinniaInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zinnia_info);
        ...
        // Bind UI components
        statusTextView = findViewById(R.id.textViewZ); // Status TextView
        saveButton = findViewById(R.id.btn_saveZinnia); // Save Button
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Zinnia"));
    }
