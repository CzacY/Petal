...
public class BougainvilleaInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bougainvillea_info);
        ...
        // Bind UI components
        statusTextView = findViewById(R.id.textViewBougM); // Status TextView
        saveButton = findViewById(R.id.btn_saveBougM); // Save Button

        mAuth = FirebaseAuth.getInstance();
        db = FirebaseFirestore.getInstance();
        commentButton = findViewById(R.id.btn_cosmosComment);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivity(new Intent(BougainvilleaInfo.this, BougainvilleaComment.class));
                } catch (Exception e) {
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Bougainvillea"));
    }
