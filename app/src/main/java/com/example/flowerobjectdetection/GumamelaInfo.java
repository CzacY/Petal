...
public class GumamelaInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gumamela_info);
        ...
        commentButton = findViewById(R.id.btn_gumamelaComment);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivity(new Intent(GumamelaInfo.this, GumamelaComment.class));
                } catch (Exception e) {
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Gumamela"));
    }
