...
public class ForgetmenotInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgetmenot_info);
        ...
        // Bind UI components
        statusTextView = findViewById(R.id.textViewForgetmenot); // Status TextView
        saveButton = findViewById(R.id.btn_saveForget); // Save Button

        mAuth = FirebaseAuth.getInstance();
        db = FirebaseFirestore.getInstance();

        commentButton = findViewById(R.id.btn_forgetmenotComment);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivity(new Intent(ForgetmenotInfo.this, ForgetmenotComment.class));
                } catch (Exception e) {
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Forgetmenot"));
    }
