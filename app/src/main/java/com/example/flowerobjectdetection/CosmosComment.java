...
public class CosmosComment extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        CollectionReference commentsRef = db.collection("plants").document("Cosmos").collection("comments");
    ...
    private void submitComment() {
        ...
        db.collection("users").document(userId).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    db.collection("plants").document("Cosmos").collection("comments")
                            .add(newComment)
