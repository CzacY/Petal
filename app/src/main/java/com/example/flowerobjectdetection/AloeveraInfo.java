...
public class AloeveraInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aloevera_info);
        ...
        // Bind UI components
        statusTextView = findViewById(R.id.textViewAloevera); // Status TextView
        saveButton = findViewById(R.id.btn_saveAloevera); // Save Button
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Aloevera"));
    }
