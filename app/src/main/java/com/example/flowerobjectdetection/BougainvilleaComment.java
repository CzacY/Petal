...
public class BougainvilleaComment extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        CollectionReference commentsRef = db.collection("plants").document("Bougainvillea").collection("comments");
    ...
    private void submitComment() {
        ...
        db.collection("users").document(userId).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    db.collection("plants").document("bougainvillea").collection("comments")
                            .add(newComment)
