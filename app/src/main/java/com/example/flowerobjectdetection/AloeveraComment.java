...
public class AloeveraComment extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        CollectionReference commentsRef = db.collection("plants").document("Aloeveras").collection("comments");
    ...
    private void submitComment() {
        ...
        db.collection("users").document(userId).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    db.collection("plants").document("Aloevera").collection("comments")
                            .add(newComment)
