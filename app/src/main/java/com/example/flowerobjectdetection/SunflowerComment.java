...
public class SunflowerComment extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        CollectionReference commentsRef = db.collection("plants").document("Sunflower").collection("comments");
    ...
    private void submitComment() {
        ...
        db.collection("users").document(userId).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    db.collection("plants").document("Sunflower").collection("comments")
                            .add(newComment)
