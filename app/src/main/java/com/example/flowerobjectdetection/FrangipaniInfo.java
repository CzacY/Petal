...
public class FrangipaniInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frangipani_info);
        ...
        // Bind UI components
        statusTextView = findViewById(R.id.textViewFrangipani); // Status TextView
        saveButton = findViewById(R.id.btn_saveFrangipani); // Save Button

        mAuth = FirebaseAuth.getInstance();
        db = FirebaseFirestore.getInstance();

        commentButton = findViewById(R.id.btn_frangipaniComment);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivity(new Intent(FrangipaniInfo.this, FrangipaniComment.class));
                } catch (Exception e) {
        ...
        saveButton.setOnClickListener(v -> savePlant(userId, "Frangipani"));
    }
